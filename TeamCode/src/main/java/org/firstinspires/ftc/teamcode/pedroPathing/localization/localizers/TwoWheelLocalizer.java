...
public class TwoWheelLocalizer extends Localizer { // todo: make two wheel odo work
    ...
    public TwoWheelLocalizer(HardwareMap map, Pose setStartPose) {
        ...
        forwardEncoderPose = new Pose(-1.0766, 4.4469, 0);
        strafeEncoderPose = new Pose(-5.3917, 0.7616, Math.toRadians(90));
        ...
        forwardEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "RB"));
